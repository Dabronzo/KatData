...
type Props = {
  id: string;
  unitySelected: EnergyType | undefined;
}

const ChipSubMenu = ({ id, unitySelected }:Props) => {
  const [selectedOption, setSelectedOption] = useState<EnergyType | undefined>(unitySelected);
  ...
  return (
    <div className="p-2 justify-center">
      <div className="mb-2">
        {selectedOption && (
          <>
            <label className="flex text-sm font-medium text-gray-700">Choose Option:</label><RadioSelection
            options={radioData}
