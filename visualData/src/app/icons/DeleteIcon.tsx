...
const DeleteIcon = ({height, width, color, className}:Props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className={className} height={height} width={width} fill={color}>
